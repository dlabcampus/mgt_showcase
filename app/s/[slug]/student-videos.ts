...
export const students = [
  {
    ...
    weeks: [
      ...
      },
      {
        ...
        label: "4주차",
        dateLabel: "2026 여름학기",
        title: "OX 퀴즈 프로젝트 소개 영상",
        summary: "소리 센서와 스위치 센서로 OX 퀴즈 게임을 만들었습니다. 퀴즈 API에서 받아온 문제를 보고 왼쪽 버튼은 O, 오른쪽 버튼은 X로 정답을 맞히고, 박수를 쳐서 소리 센서가 큰 소리를 감지하면 다음 문제로 넘어가도록 만들었습니다.",
        videoPath: "/videos/g4m9-volt/b7k3-quiz-note.mp4",
        downloadName: "mgtlab-noa-week-4.mp4",
      },
      {
        id: "2026-summer-w5",
        label: "5주차",
        dateLabel: "2026 여름학기",
        title: "이름 통계 API활용 프로젝트 소개 영상",
        summary: "이름 통계 API를 활용해 입력한 이름으로 평균 나이와 성별을 추측하고, 그 예측 결과와 실제 통계값의 차이만큼 서보 모터가 다른 각도로 움직이도록 만들었습니다!",
        videoPath: "/videos/w7k3-summit/d4p8-servo-note.mp4",
        downloadName: "mgtlab-noa-week-5.mp4",
        isLatest: true,
      },
    ],
  },
  ...
  },
  {
    ...
    weeks: [
      ...
      },
      {
        ...
        title: "OX 퀴즈 프로젝트 소개 영상",
        summary: "소리 센서와 스위치 센서로 OX 퀴즈 게임을 만들었습니다. 퀴즈 API에서 받아온 문제를 보고 왼쪽 버튼은 O, 오른쪽 버튼은 X로 정답을 맞히고, 박수를 쳐서 소리 센서가 큰 소리를 감지하면 다음 문제로 넘어가도록 만들었습니다.",
        videoPath: "/videos/p2x6-relay/k9d4-quiz-record.mp4",
        downloadName: "mgtlab-jaeyun-week-4.mp4",
      },
      {
        id: "2026-summer-w5",
        label: "5주차",
        dateLabel: "2026 여름학기",
        title: "이름 통계 프로젝트 소개 영상",
        summary: "이름 통계 API를 활용해 입력한 이름으로 평균 나이와 성별을 추측하고, 그 예측 결과에 따라 서보 모터가 다른 각도로 움직이도록 만들었습니다.",
        videoPath: "/videos/n5q8-meadow/r6t2-motor-record.mp4",
        downloadName: "mgtlab-jaeyun-week-5.mp4",
        isLatest: true,
      },
    ],
  },
